(() => {
  ...
  const STRINGS = {
    en: {
      ...
      heroEyebrow:'AN OPEN COMMUNITY PROJECT', tagline:'Community-built plugins for DIOXAMINE.', heroBody:'Discover new plugins, extend your setup, and explore what the DIOXAMINE community is building.', getPlugins:'Get Plugins', viewRepo:'View Repository', independent:'An independent project maintained by the DIOXAMINE community.', catalogueStatus:'CATALOGUE STATUS', live:'LIVE', availablePlugins:'plugins available', catalogueSource:'Catalogue source', distribution:'Distribution', reviewStatus:'Review model', communityReview:'Community review', panelFoot:'Open catalogue · transparent packages · community-led', previewAria:'Live community catalogue preview', previewTitle:'Find your next plugin.', previewTools:'TOOLS', previewDeveloper:'DEVELOPER', previewOpen:'OPEN CATALOGUE', previewDistribution:'NO RELEASES REQUIRED', sourceChip:'A public, versioned index', previewEmptyTitle:'A space for community plugins', previewEmptyBody:'The first listing starts here.', previewCaption:'OPEN · COMMUNITY-MAINTAINED', pluginsListed:'PLUGINS LISTED', reviewBeforeListing:'Community submissions are reviewed before listing.',
    ...
    de: {
      ...
      heroEyebrow:'EIN OFFENES COMMUNITY-PROJEKT', tagline:'Community-Plugins für DIOXAMINE.', heroBody:'Entdecke neue Plugins, erweitere dein Setup und sieh dir an, was die DIOXAMINE-Community entwickelt.', getPlugins:'Plugins installieren', viewRepo:'Repository ansehen', independent:'Ein unabhängiges, von der DIOXAMINE-Community gepflegtes Projekt.', catalogueStatus:'KATALOGSTATUS', live:'LIVE', availablePlugins:'Plugins verfügbar', catalogueSource:'Katalogquelle', distribution:'Verteilung', reviewStatus:'Prüfung', communityReview:'Community-Prüfung', panelFoot:'Offener Katalog · nachvollziehbare Pakete · von der Community getragen', previewAria:'Live-Vorschau des Community-Katalogs', previewTitle:'Finde dein nächstes Plugin.', previewTools:'WERKZEUGE', previewDeveloper:'ENTWICKLER', previewOpen:'OFFENER KATALOG', previewDistribution:'KEINE RELEASES NÖTIG', sourceChip:'Ein öffentlicher, versionierter Katalog', previewEmptyTitle:'Platz für Community-Plugins', previewEmptyBody:'Der erste Eintrag beginnt hier.', previewCaption:'OFFEN · VON DER COMMUNITY GEPFLEGT', pluginsListed:'GELISTETE PLUGINS', reviewBeforeListing:'Community-Einreichungen werden vor der Aufnahme geprüft.',
