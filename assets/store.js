(() => {
  ...
  const STRINGS = {
    en: {
      skip:'Skip to content', community:'COMMUNITY CATALOGUE', browse:'Browse plugins', submit:'Submit a plugin', repository:'Repository', menuLabel:'Open navigation menu', home:'Home', theme:'Theme',
      heroEyebrow:'AN OPEN COMMUNITY PROJECT', tagline:'Community-built plugins for DIOXAMINE.', heroBody:'Discover new plugins, extend your setup, and explore what the DIOXAMINE community is building.', getPlugins:'Get Plugins', viewRepo:'View Repository', independent:'An independent project maintained by the DIOXAMINE community.', catalogueStatus:'CATALOGUE STATUS', live:'LIVE', availablePlugins:'plugins available', catalogueSource:'Catalogue source', distribution:'Distribution', reviewStatus:'Review model', communityReview:'Community review', panelFoot:'Open catalogue · transparent packages · community-led',
